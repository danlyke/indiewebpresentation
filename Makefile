...
all:
	...
	perl -e 'while (<>) { s%file:///usr/lib/python2.7/dist-packages/landslide/%%g; s%file:///home/danlyke/code/nodejspresentation/%%g; s%src=".*?diagrams/%src="diagrams/%g; print }' <  presentation.html > $(TARGETDIR)presentation.html
